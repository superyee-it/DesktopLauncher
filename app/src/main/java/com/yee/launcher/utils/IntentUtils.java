...
public final class IntentUtils {
    ...
    public static void startAppFromLauncher(Context context, View v, Intent intent) {
    ...
    public static void startFromLauncher(Context context, View v, DesktopItemInfo itemInfo) {
        Intent intent = itemInfo.getIntent();
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_TASK_ON_HOME);
        startAppFromLauncher(context, v, intent);
    }
