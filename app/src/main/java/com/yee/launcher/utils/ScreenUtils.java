...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return GlobalApplication.getInstance().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) GlobalApplication.getInstance().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                GlobalApplication.getInstance().getContentResolver(),
